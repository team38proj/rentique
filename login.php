...
/*
Saja (backend) - process login submission
*/
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Rentique uses email for login, not username
    ...
    if (empty($errors)) {
        $stmt = $db->prepare("SELECT uid, email, password FROM users WHERE email = ?");
        $stmt->execute([$email]);
...
<head>
    ...
    <link rel="stylesheet" href="/rentiquefinal/css/rentique.css">
