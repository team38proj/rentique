    ...
    <div class="container">
        <div class="mission-layout">
            <div class="mission-content">
                <h3>Review Us</h3>
                <p>
                    <span class="highlight">How are we doing?</span>: Rentique began as a simple concept to address the direction fashion is going and its impact on the world.
